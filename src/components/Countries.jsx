...
const Countries = () => {
  ...
  const paginatedCountries = filteredCountries.slice((activePage - 1) * itemsPerPage, activePage * itemsPerPage);
    ...
    <Container fluid>
      ...
      <Row xs={2} md={3} lg={4} className='g-3'>
        {paginatedCountries.map((country) => {
          ...
          const handleToggleFavourite = () => {
            isFavourite ? dispatch(removeFavourite(country.name.common)) : dispatch(addFavourite(country.name.common));
          };
            ...
            <Col className='mt-5' key={country.name.official}>
              <Card className='h-100'>
                ...
                <Card.Body className='d-flex flex-column'>
                  ...
                  <Button variant={isFavourite ? 'warning' : 'primary'} onClick={handleToggleFavourite}>
      ...
      {totalPages > 1 && (
        <Row className='justify-content-center mt-4'>
          <Col xs='auto'>
            <Pagination>
              <Pagination.Item active={1 === activePage} onClick={() => handlePageChange(1)}>
                1
              </Pagination.Item>
              ...
              {totalPages > 1 && (
                <Pagination.Item active={totalPages === activePage} onClick={() => handlePageChange(totalPages)}>
                  {totalPages}
                </Pagination.Item>
              )}
            </Pagination>
